    ...
    <div class="textbox">
        ...
        <div class="form_center" id="recipe-form">
            <?php $form = ActiveForm::begin(['id' => 'recipeForm']) ?>
                ...
                <div class="p40"></div>
                <div class="add_ing_box" data-num="0">
                    <div class="cb">
                        <h3>Ингредиенты</h3>
                        <div class="add_ing_descr hint">
                            Введите название списка. Например: Для теста
                        </div>
                        <?= Html::activeTextInput($model, 'ingredientSection[0]', ['class' => 'input_base', 'placeholder' => 'Основные ингредиенты']) ?>
                    </div>
                    <div class="add_ing_descr hint">
                    ...
                    <?php for ($i = 0; $i < 4; $i++): ?>
                        ...
                        <div class="add_ing_inputs_box_1">
                            <div class="inputbox_input">
                                <?= Html::activeTextInput($model, 'ingredientName[0][' . $i . ']', [
                                    'class' => 'input_base',
                        ...
                        <div class="add_ing_inputs_box_2">
                            <div class="inputbox_input">
                                <?= Html::activeTextInput($model, 'ingredientQuantity[0][' . $i . ']', ['class' => 'input_base', 'placeholder' => 'Кол-во']) ?>
                            </div>
                        </div>
                        <div class="add_ing_inputs_box_rasp"></div>
                        <div class="add_ing_inputs_box_3">
                            <div class="inputbox_input">
                                <?php echo AutoComplete::widget([
                                    'name' => $model->formName() . '[ingredientUom][0][' . $i . ']',
                                    'id' => 'uom-0-' . $i,
                                    'options' => [
                                        'class' => 'input_base',
                                        'placeholder' => 'Ед.',
                ...
                <div class="add_recipe_bottom">
                    <a href="javascript:void(0)" class="b_red" data-button="submitForm"><i class="fa fa-plus"></i>Добавить рецепт</a>
                </div>
