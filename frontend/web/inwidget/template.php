...
<html lang="ru">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?= $inWidget->skinPath.$inWidget->skinName ?>.css?r3" media="all" />
		<?php if($inWidget->adaptive === false): ?>
			<style type='text/css'>
				...
				.widget .data a.image:link, .widget .data a.image:visited {
					width:calc(<?= $inWidget->imgWidth ?>px - 4px);
					height:<?= $inWidget->imgWidth ?>px;
				}
				.widget .data .image span {
					width:calc(<?= $inWidget->imgWidth ?>px - 3px);
					height:<?= $inWidget->imgWidth ?>px;
				}
				.copyright {
